...
namespace QAI.FSM
{
    ...
    public class FSMStateNodeEditor : NodeEditor
    {
        ...
        protected virtual void OnTransitionsGUI()
        {
            ...
            if (_entry == null)
            {
                _entry = target.AddInstanceInput(typeof(FSMConnection), Node.ConnectionType.Override, Node.TypeConstraint.None, "entry");
            }
            ...
            if (_exit == null)
            {
                _exit = target.AddInstanceOutput(typeof(FSMConnection), Node.ConnectionType.Override, Node.TypeConstraint.None, "exit");
            }
